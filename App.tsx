...
import { FullStudentProfile, User } from './types';
import { GraduationCap, Sparkles, LogOut, ArrowLeft } from 'lucide-react';

type ViewState = 'login' | 'signup' | 'dashboard' | 'form' | 'profile';
...
function App() {
  ...
  const handleLogin = (email: string) => {
    // Simulated login
    setUser({ name: 'Faculty Member', email });
    setView('dashboard');
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-12 font-inter">
      ...
      <main className="max-w-5xl mx-auto px-4 mt-8">
        ...
        {/* Breadcrumb / Back Button for nested views */}
        {user && (view === 'form' || view === 'profile') && (
          <button 
